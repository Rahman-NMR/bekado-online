...
data class TrxListModel(
    val uidOwnerTrx: String? = "",
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        parcel.writeString(uidOwnerTrx)
    ...
    companion object CREATOR : Parcelable.Creator<TrxListModel> {
        override fun createFromParcel(parcel: Parcel): TrxListModel {
            return TrxListModel(parcel)
        }

        override fun newArray(size: Int): Array<TrxListModel?> {
